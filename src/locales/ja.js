...
export default {
  ...
  notFound: {
    404: '404',
    message: 'おっと！道に迷ったようです </br> このページは移動または削除されました',
    title: 'ページが見つかりません',
    heading: 'ページが見つかりません',
    home: 'ホームページ',
  },
  ...
  newsletter: {
    heading: '更新についての通知を受けるにはサインアップしてください。',
    button: 'サインアップ',
    input: 'メールアドレスを入力してください',
    skyminerOption: 'スカイワイヤーマイナーには興味があります',
  },
  markets: {
    title: 'Buy Skycoin',
  ...
  home: {
    ...
    hero: {
      heading: '新しい世界のための、新しいインターネット',
      paragraph'Skycoinプラットフォームは、世界で最も進んだブロックチェーンプロジェクトです。ビットコイン、イーサリアムの黎明期に貢献した開発者によって創られたSkycoinのプラットフォームは、完全なセキュリティと無限の拡張性を備え、ISP（インターネットサービスプロバイダ）を必要としません。Skycoinは帯域幅（処理速度）、ストレージ、そして計算リソースをその価値の裏付けとして、Satoshiの最初のビジョンを実現するために作られました。',
      buy: 'Buy Skycoin',
      // community: 'Community',
      // whitepapers: 'Whitepapers',
      wallet: {
    ...
    network: {
      ...
      heading: 'Obelisk',
      subheading: 'Skycoinの合意形成アルゴリズム',
      body: 'Skycoinではユーザが求めるものである、中央の権力者を持たない本当の分散ネットワークを届けます。この課題を達成するため、わたしたちはPoWやPoSを越え、ブロックチェーンの内部の仕組みを再構成するまったく新しい分散アルゴリズムを創り出しました。わたしたちの分散型合意形成アルゴリズム、Obeliskはまさにそのようなネットワークの実現に成功しています。<br/><br/>そのweb-of-trust(信頼のウェブ)合意形成は、権力の中央集権化を防ぎます。Skycoinはマイニングを必要とせず、51%攻撃への耐性を持ち、その決済は数秒で完了します。決定は少数の主要な利害関係者の願望によってではなく、コミュニティの合意によってなされます。</p>',
    },
    miner: {
      heading: 'Skyminerについて',
      subheading: 'Skyminerは、Skywire(新しい分散インターネット)に磐石の通信回線を供給するため、細心の注意を払って計画・構成されています。ハードウェアは、セキュリティ・効率性・パフォーマンスを、ソフトウェア定義されたネットワークで最大限に発揮するための特注品です。複数基板の構造により、それぞれのノードはSkywire上の独立したサービスをサポートすることができます。ノードを分離することで、それぞれのサービスは周辺サービスへの攻撃があったとしても安全に稼動することができます。サービス提供ノードはさらなるセキュリティのため、パケット転送・アクセス操作の厳格なルールを持つOpenWRTのルーターで管理されます。Skywireにサービス・セキュリティを提供することで、SkyminerにはSkyhour(第二の通貨)が支払われます。',
      link: 'Become a node',
      more: 'Learn more',
    },
    press: {
      heading: 'Skycoinは2018年に注目すべき仮想通貨プロジェクトトップ5に選ばれました',
      body: '“2017年のテクノロジー分野では、インターネットの中立性と消費者データのプライバシーの2つが重要な課題であることが明らかになりました。SP（インターネットサービスプロバイダ）へのバカげた額の料金支払い、頼りなく狭い受信エリア、ユーザデータの販売、政府による監視・検閲。こうした問題を心配している人にとって、Skycoinは希望です。これこそ、Skycoinが解決しようとしている問題なのです。”',
    },
    ecosystem: {
      heading: 'Skycoinは世界で最も進んだブロックチェーンアプリケーションプラットフォーム',
      subheading: 'Skycoinのエコシステム',
      fiber: {
        title: 'Fiber',
        text: '無限の拡張性、高度なカスタマイズ性を持つSkycoinプラットフォームの並列ピアチェーンアーキテクチャです。',
      },
      obelisk: {
        title: 'Obelisk',
        text: 'PoWとPoSの根本的な欠陥を解決する、web-of-trust(信頼のウェブ)方式の新しい合意形成アルゴリズムです。',
      },
      skycoin: {
        title: 'Skycoin',
        text: '史上最も強力で完全な、仮想通貨プラットフォームです。',
      },
      coinHours: {
        title: 'Coin Hours',
        text: 'Skycoinを持っていると貰えます。Skycoinプラットフォーム上のサービスにおける支払い手段です。',
      },
      coinJoin: {
        title: 'Coin Join',
        text: 'Skywireプラットフォームは、完全にプライベートで追跡不可能な決済を提供するためCoinJoinに対応しています。',
      },
      skyledger: {
        title: 'Skyledger',
      ...
      skywire: {
        title: 'Skywire',
        text: 'ワイヤレスメッシュネットワークの新しい分散インターネットです。ネットワークを支援することで報酬が貰えます。',
      },
      skyminer: {
        title: 'Skyminer',
        text: '分散インターネットを破壊不可能なものにするためのハードウェアです。帯域幅（処理速度）、ストレージ、そしてCPUリソースを提供して、寝ている間も報酬を受け取りましょう。',
      },
      nodes: {
        title: 'ノード',
        text: 'Skywireネットワークを形成するブロックです。Skywireエコシステムの非中央集権性を確保するため、誰でも設置できます。',
      },
      cx: {
        title: 'CX',
        text: 'Go言語で作られた専用プログラミング言語です。簡単に学べて、素早く実装できるようにデザインされています。',
      },
      cxo: {
        title: 'CXO',
        text: 'Skywireの分散ネットワークのために調整された、P2Pのクラウドストレージサービスです。',
      },
      kittyCash: {
        title: 'KittyCash',
        text: 'Fiberで今、最も人気のアプリです。Kittycashは完全なゲームのエコシステムで、ネコを備えています。',
      },
      skyVpn: {
        title: 'SDN',
      ...
      skyMessenger: {
        title: 'SkyMessenger',
        text: '暗号化されたメッセンジャーサービスです。覗きや迷惑行為がありません。',
      },
      bbs: {
        title: 'BBS',
        text: '分散SNSのためのフレームワークです。',
      },
    },
    news: {
      heading: 'News',
    ...
    signup: {
      heading: 'Skyfleetのメルマガに登録して、Skycoinと新たな高みへ！',
      body: '乗り遅れないようにSkyfleetのメルマガに登録して、Skycoinチームからのアップデートを受け取ろう！メールアドレス登録して打ち上げに備える',
      button: 'Sign Up',
    },
    // roadmap: {
    //   heading: 'Roadmap',
  ...
  downloads: {
    title: 'ダウンロード',
    description: 'Skycoinウォレットをダウンロードする',
    wallet: {
      heading: 'Skycoinウォレットをダウンロードする',
      ...
      build: '現行のビルドは{version}です.',
      macos: 'MacOS',
      linux: 'Linux',
      windows: 'Windows',
      withElectron: 'Installer',
      withElectronComment: ' (推奨)',
      withoutElectron: 'Portable',
      withoutElectronComment: ' (上級ユーザー向け)',
      download: 'ダウンロード',
      signature: 'デジタル署名',
      torrent: 'Torrent',
    },
    bbs: {
      heading: 'Skycoin BBSをダウロードする',
      lead: 'Skycoin BBSはFiberというSkycoinブロックチェーンテクノロジーを使用して構築された次世代分散型ソーシャルネットワークです。',
      githublink: '最新のバイナリーはGithubから入手できます。',
      thinclient: 'シンクライアント（軽量端末）にアクセスする。',
    },
    whitepapers: {
      heading: 'Skycoinコンセンサスのホワイトペーパーをダウンロードする',
      download: 'ダウンロード',
    ...
    assets: {
      heading: 'Skycoinブランドガイドラインをダウンロードする',
      guidelines: 'Skycoin Brand Guidelines',
      logo: 'SkycoinロゴのPNGファイル',
      font: 'Skycoin Sansフォント',
    },
    skywire: {
      heading: 'Skywire',
